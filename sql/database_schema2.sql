...
-- OjoTokenMining Database Schema - Updated with Address Fields
-- This version includes address fields for global user locations
...
CREATE TABLE withdrawal_requests (
    ...
    method ENUM('usdt_bep20','jojo_token') DEFAULT 'jojo_token',
