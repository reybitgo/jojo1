...
// Forces the next monthly bonus cycle for every eligible package,
// ignoring the 30-day wait.  Run via:
// https://your-domain.com/cron/force_bonus.php?key=YOUR_SECRET_KEY
...
try {
    ...
    foreach ($packages as $row) {
        ...
        // 4. advance cycle / mark completed
        ...
        $pdo->commit();
        echo "Forced {$bonus} " . DEFAULT_CURRENCY . " to {$row['username']} (cycle {$row['current_cycle']})\n";
    }
